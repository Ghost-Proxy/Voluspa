...
If you have any questions about anything, feel free to ask in general chat, use the `$feedback` Voluspa feature, or use the `@ghost-proxy-vanguard` ping to ask for help from the Ghost Proxy admin team.

\\*\\*\\*

And finally, a couple of steps to do now that you have arrived:
